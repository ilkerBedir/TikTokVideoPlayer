...
public class EightTeamsController implements ControllerInterface {
    private static final Logger LOGGER = LoggerFactory.getLogger(EightTeamsController.class);
    @FXML
    ...
    @FXML
    private HBox hbox_team7;
    @FXML
    private Label point_team7;
    @FXML
    private MediaView video_team7;
    @FXML
    private HBox hbox_team8;
    @FXML
    private Label point_team8;
    @FXML
    private MediaView video_team8;
    @FXML
    ...
    private String COMMENTARY_URL_TEAM7;
    private String COMMENTARY_URL_TEAM8;
    ...
    private String VIDEO_URL_TEAM7;
    private String VIDEO_URL_TEAM8;
    ...
    private String MARS_URL_TEAM7;
    private String MARS_URL_TEAM8;
    ...
    private List<MediaPlayer> team7MusicMediaPlayers;
    private List<MediaPlayer> team8MusicMediaPlayers;
    ...
    private Timeline team7Timeline;
    private Timeline team8Timeline;
    ...
    private List<Gift> team7Gifts;
    private List<Gift> team8Gifts;
    ...
    private String WINNING_VIDEO_TEAM7;
    private String WINNING_VIDEO_TEAM8;
    @FXML
    ...
    public void display(String team1Folder, String team2Folder, String team3Folder, String team4Folder, String team5Folder, String team6Folder, String team7Folder, String team8Folder, String neutralMusicPath, int countGiftImage, List<String> team1GiftNames, List<String> team2GiftNames, List<String> team3GiftNames, List<String> team4GiftNames, List<String> team5GiftNames, List<String> team6GiftNames, List<String> team7GiftNames, List<String> team8GiftNames, int time, int extendedTime) {
        LOGGER.debug("8 takımlı yarış display");
        this.NEUTRAL_MUSIC_URL = neutralMusicPath;
        this.COUNT_IMAGE_PER_TEAM = countGiftImage;
        editFolders(team1Folder, team2Folder, team3Folder, team4Folder, team5Folder, team6Folder, team7Folder, team8Folder);
        ...
        team7Gifts = mediaPlayerUtils.teamGifts(team7GiftNames);
        team8Gifts = mediaPlayerUtils.teamGifts(team8GiftNames);
    ...
    private void createTimelineTeams(MediaPlayerUtils mediaPlayerUtils) {
        ...
        team7Timeline = createTimelineTeams(mediaPlayerUtils.createVolumeFiles(this.COMMENTARY_URL_TEAM7));
        team8Timeline = createTimelineTeams(mediaPlayerUtils.createVolumeFiles(this.COMMENTARY_URL_TEAM8));
    }
    ...
    private void createMusicPlayers(MediaPlayerUtils mediaPlayerUtils) {
        ...
        team7MusicMediaPlayers = mediaPlayerUtils.createVolumeFiles(this.MARS_URL_TEAM7);
        team8MusicMediaPlayers = mediaPlayerUtils.createVolumeFiles(this.MARS_URL_TEAM8);
    }
    ...
    private void editMusicPlayers() {
        ...
        editMusicPlayers(team7MusicMediaPlayers);
        editMusicPlayers(team8MusicMediaPlayers);
    }
    ...
    private void editHBoxes(MediaPlayerUtils mediaPlayerUtils) {
        ...
        hbox_team7.getChildren().addAll(mediaPlayerUtils.createGiftsHBOX(team7Gifts));
        hbox_team8.getChildren().addAll(mediaPlayerUtils.createGiftsHBOX(team8Gifts));
    }

    private void editFolders(String team1Folder, String team2Folder, String team3Folder, String team4Folder, String team5Folder, String team6Folder, String team7Folder, String team8Folder) {
        ...
        this.COMMENTARY_URL_TEAM7 = team7Folder + "/belgesel";
        this.COMMENTARY_URL_TEAM8 = team8Folder + "/belgesel";
        ...
        this.MARS_URL_TEAM7 = team7Folder + "/mars";
        this.MARS_URL_TEAM8 = team8Folder + "/mars";
        ...
        this.VIDEO_URL_TEAM7 = team7Folder + "/video";
        this.VIDEO_URL_TEAM8 = team8Folder + "/video";
        ...
        this.WINNING_VIDEO_TEAM7 = team7Folder + "/winning_video";
        this.WINNING_VIDEO_TEAM8 = team8Folder + "/winning_video";
    }
            ...
            protected Task<Void> createTask() {
                Task task = new Task<Void>() {
                    ...
                    public Void call() {
                        while (threadFlag) {
                            ...
                            switch (messageType) {
                                ...
                                case "Like": {
                                    ...
                                    Platform.runLater(() -> label_like_race4.setText("Son Beğenen : " + ((String) finalValue[1])));
                                    break;
                                }
                                case "Comment": {
                                    String[] finalValue = value;
                                    Platform.runLater(() -> label_comment_race4.setText("Son Yorum Yapan : " + ((String) finalValue[1])));
                                    break;
                                }
                                case "Gift", "GiftCombo": {
                                    String[] finalValue = value;
                                    ...
                                    Optional<Gift> gift7 = team7Gifts.stream().filter(gift -> gift.getName().equals(name)).findAny();
                                    Optional<Gift> gift8 = team8Gifts.stream().filter(gift -> gift.getName().equals(name)).findAny();
                                    ...
                                    String labelPoint7 = point_team7.getText();
                                    String labelPoint8 = point_team8.getText();
                                    ...
                                    int point7 = Integer.parseInt(labelPoint7);
                                    int point8 = Integer.parseInt(labelPoint8);
                                    if (gift1.isPresent()) {
                                        if ((point1 <= point2 || point1 <= point3 || point1 <= point4 || point1 <= point5 || point1 <= point6 || point1 <= point7 || point1 <= point8) && (point1 + hediye_miktari > point4 && point1 + hediye_miktari > point2 && point1 + hediye_miktari > point3 && point1 + hediye_miktari > point5 && point1 + hediye_miktari > point6 && point1 + hediye_miktari > point7 && point1 + hediye_miktari > point8)) {
                                            ...
                                            mediaPlayer.seek(Duration.ZERO);
                                            sharing_music_race4.setMediaPlayer(mediaPlayer);
                                            sharing_music_race4.getMediaPlayer().setOnError(()->setOnErrorMusic(team1MusicMediaPlayers));
                                            sharing_music_race4.getMediaPlayer().play();
                                            if (sharing_commentary_race4.getMediaPlayer() != null) {
                                                sharing_commentary_race4.getMediaPlayer().stop();
                                            }
                                        ...
                                        if ((point2 <= point1 || point2 <= point3 || point2 <= point4 || point2 <= point5 || point2 <= point6 || point2 <= point7 || point2 <= point8) && (point2 + hediye_miktari > point1 && point2 + hediye_miktari > point3 && point2 + hediye_miktari > point4 && point2 + hediye_miktari > point5 && point2 + hediye_miktari > point6 && point2 + hediye_miktari > point7 && point2 + hediye_miktari > point8)) {
                                        ...
                                        if ((point3 <= point1 || point3 <= point2 || point3 <= point4 || point3 <= point5 || point3 <= point6 || point3 <= point7 && point3 <= point8) &&
                                                (point3 + hediye_miktari > point1 && point3 + hediye_miktari > point2 &&
                                                        point3 + hediye_miktari > point4 && point3 + hediye_miktari > point5
                                                        && point3 + hediye_miktari > point6 && point3 +hediye_miktari>point7
                                                && point3+hediye_miktari>point8)) {
                                        ...
                                        if ((point4 <= point1 || point4 <= point3 || point4 <= point2 ||
                                                point4 <= point5 || point4 <= point6 || point4<=point7 || point4<=point8)
                                                && (point4 + hediye_miktari > point1 && point4 + hediye_miktari > point3 && point4 + hediye_miktari > point2 && point4 + hediye_miktari > point5 && point4 + hediye_miktari > point6 && point4+hediye_miktari>point7 && point4+hediye_miktari>point8)) {
                                        ...
                                        if ((point5 <= point1 || point5 <= point3 || point5 <= point2 || point5 <= point4 || point5 <= point6 || point5<=point7 || point5<=point8) && (point5 + hediye_miktari > point1 && point5 + hediye_miktari > point2 && point5 + hediye_miktari > point3 && point5 + hediye_miktari > point4 && point5 + hediye_miktari > point6 && point5+hediye_miktari<point7 && point5+hediye_miktari>point8)) {
                                            LOGGER.debug("Takım Değişti Team5");
                                            increaseTime();
                                            currentTeamIndex = 0;
                                            sharing_music_race4.getMediaPlayer().stop();
                                            MediaPlayer mediaPlayer = team5MusicMediaPlayers.get(currentTeamIndex);
                                            mediaPlayer.seek(Duration.ZERO);
                                            sharing_music_race4.setMediaPlayer(mediaPlayer);
                                        ...
                                        if ((point6 <= point1 || point6 <= point3 || point6 <= point2 || point6 <= point5 || point6 <= point4 || point6<=point7 || point6<=point8) && (point6 + hediye_miktari > point1 && point6 + hediye_miktari > point3 && point6 + hediye_miktari > point2 && point6 + hediye_miktari > point5 && point6 + hediye_miktari > point4 && point6+hediye_miktari>point7 && point6+hediye_miktari>point8)) {
                                            LOGGER.debug("Takım Değişti Team6");
                                            increaseTime();
                                            currentTeamIndex = 0;
                                            sharing_music_race4.getMediaPlayer().stop();
                                            MediaPlayer mediaPlayer = team6MusicMediaPlayers.get(currentTeamIndex);
                                            mediaPlayer.seek(Duration.ZERO);
                                            sharing_music_race4.setMediaPlayer(mediaPlayer);
                                    ...
                                    } else if (gift7.isPresent()) {
                                        if ((point7 <= point1 || point7 <= point3 || point7 <= point2 || point7 <= point5 || point7 <= point4 || point7<=point6 || point7<=point8) && (point7 + hediye_miktari > point1 && point7 + hediye_miktari > point3 && point7 + hediye_miktari > point2 && point7 + hediye_miktari > point5 && point7 + hediye_miktari > point4 && point7+hediye_miktari>point6 && point7+hediye_miktari>point8)) {
                                            LOGGER.debug("Takım Değişti Team7");
                                            increaseTime();
                                            currentTeamIndex = 0;
                                            sharing_music_race4.getMediaPlayer().stop();
                                            MediaPlayer mediaPlayer = team7MusicMediaPlayers.get(currentTeamIndex);
                                            mediaPlayer.seek(Duration.ZERO);
                                            sharing_music_race4.setMediaPlayer(mediaPlayer);
                                            sharing_music_race4.getMediaPlayer().setOnError(()->setOnErrorMusic(team7MusicMediaPlayers));
                                            sharing_music_race4.getMediaPlayer().play();
                                            if (sharing_commentary_race4.getMediaPlayer() != null) {
                                                sharing_commentary_race4.getMediaPlayer().stop();
                                            }
                                    ...
                                    }else if (gift8.isPresent()) {
                                        if ((point8 <= point1 || point8 <= point3 || point8 <= point2 || point8 <= point5 || point8 <= point4 || point8<=point7 || point8<=point6) && (point8 + hediye_miktari > point1 && point8 + hediye_miktari > point3 && point8 + hediye_miktari > point2 && point8 + hediye_miktari > point5 && point8 + hediye_miktari > point4 && point8+hediye_miktari>point7 && point8+hediye_miktari>point6)) {
                                            LOGGER.debug("Takım Değişti Team8");
                                            increaseTime();
                                            currentTeamIndex = 0;
                                            sharing_music_race4.getMediaPlayer().stop();
                                            MediaPlayer mediaPlayer = team8MusicMediaPlayers.get(currentTeamIndex);
                                            mediaPlayer.seek(Duration.ZERO);
                                            sharing_music_race4.setMediaPlayer(mediaPlayer);
                                            sharing_music_race4.getMediaPlayer().setOnError(()->setOnErrorMusic(team8MusicMediaPlayers));
                                            sharing_music_race4.getMediaPlayer().play();
                                            if (sharing_commentary_race4.getMediaPlayer() != null) {
                                                sharing_commentary_race4.getMediaPlayer().stop();
                                            }
                        ...
                        LOGGER.debug("While Döngüsünden çıkış yapıldı");
                        return null;
                    }
                };
                return task;
    ...
    public void close() {
        ...
        if (video_team7.getMediaPlayer() != null) {
            video_team7.getMediaPlayer().stop();
        }
        if (video_team8.getMediaPlayer() != null) {
            video_team8.getMediaPlayer().stop();
        }
    ...
    public void finishRace() {
        ...
        int team7point = Integer.parseInt(point_team7.getText());
        int team8point = Integer.parseInt(point_team8.getText());
        MediaPlayerUtils mediaPlayerUtils = new MediaPlayerUtils();
        MediaPlayer video;
        String uri;
        if (team1point > team2point && team1point > team3point && team1point > team4point && team1point > team5point && team1point > team6point && team1point>team7point && team1point>team8point) {
            video = mediaPlayerUtils.getVideo(this.WINNING_VIDEO_TEAM1);
            uri=this.WINNING_VIDEO_TEAM1;
        } else if (team2point > team1point && team2point > team3point && team2point > team4point && team2point > team5point && team2point > team6point && team2point>team7point && team2point>team8point) {
            video = mediaPlayerUtils.getVideo(this.WINNING_VIDEO_TEAM2);
            uri=this.WINNING_VIDEO_TEAM2;
        } else if (team3point > team4point && team3point > team2point && team3point > team1point && team3point > team5point && team3point > team6point && team3point>team7point && team3point>team8point) {
            video = mediaPlayerUtils.getVideo(this.WINNING_VIDEO_TEAM3);
            uri=this.WINNING_VIDEO_TEAM3;
        } else if (team4point > team3point && team4point > team2point && team4point > team1point && team4point > team5point && team4point > team6point && team4point>team7point && team4point>team8point) {
            video = mediaPlayerUtils.getVideo(this.WINNING_VIDEO_TEAM4);
            uri=this.WINNING_VIDEO_TEAM4;
        } else if (team5point > team3point && team5point > team2point && team5point > team1point && team5point > team4point && team5point > team6point && team5point>team7point && team5point>team8point) {
            video = mediaPlayerUtils.getVideo(this.WINNING_VIDEO_TEAM5);
            uri=this.WINNING_VIDEO_TEAM5;
        } else if (team6point > team3point && team6point > team2point && team6point > team1point && team6point > team4point && team6point > team5point && team6point>team7point && team6point>team8point) {
            video = mediaPlayerUtils.getVideo(this.WINNING_VIDEO_TEAM6);
            uri=this.WINNING_VIDEO_TEAM6;
        } else if (team7point > team3point && team7point > team2point && team7point > team1point && team7point > team4point && team7point > team5point && team7point>team6point && team7point>team8point) {
            video = mediaPlayerUtils.getVideo(this.WINNING_VIDEO_TEAM7);
            uri=this.WINNING_VIDEO_TEAM7;
        }else {
            video = mediaPlayerUtils.getVideo(this.WINNING_VIDEO_TEAM8);
            uri=this.WINNING_VIDEO_TEAM8;
        }
